...
const std::string kTsSingleTapPressedPath = kTsPath + "single_pressed";
const std::string kTsSingleTapEnabledPath = kTsPath + "single_en";
...
const std::string kTsDoubleTapPressedPath = kTsPath + "double_pressed";
